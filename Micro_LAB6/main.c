...
// beginning of area for all students changes
        ...
        else
        {
            ...
            if(temp >= temproom * 1.03) {  //if temp is higher than 1.03 of temproom, turn LED2 on
                P1OUT |= BIT5;
                __delay_cycles(200);

            }else {   //if temp is lower  than 1.01 of temproom, turn LED2 off
                P1OUT &= ~BIT5;
                __delay_cycles(200);
            }
        ...
        else
        {
            ...
            if(touch >= touchroom * 0.9) {P2OUT &= ~BIT0; __delay_cycles(200);}  // off (non-touch)
